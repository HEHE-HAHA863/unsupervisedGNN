...
def test_single(gnn, gen, n_classes, it):
    ...
    output_filename = "all_test_results_p=0.1_q=0.05_n1=300.xlsx"
...
if __name__ == '__main__':
    ...
    args.generative_model = "specific_SBM_multiclass"
    ...
    if (args.mode == 'test'):
        ...
        filename = "gnn_J4_lyr20_Ntr1000_num2000_p=0.1_q=0.05_n1= 300"
        ...
        if ((filename != '') and (os.path.exists(path_plus_name))):
            ...
            print ('No such a gnn exists; creating a brand new one')
            filename = 'gnn_J' + str(args.J) + '_lyr' + str(args.num_layers) + '_Ntr' + str(args.N_train) + '_num' + str(args.num_examples_train)+ '_p=' + str(args.p_SBM)  + '_q=' + str(args.q_SBM) + '_n1=300_train6000'
            path_plus_name = os.path.join(args.path_gnn, filename)
            if (args.generative_model == 'SBM_multiclass' or args.generative_model == 'specific_SBM_multiclass'):
                gnn = GNN_multiclass(args.num_features, args.num_layers, args.J + 2, n_classes=args.n_classes)
